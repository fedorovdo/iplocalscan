...
TRANSLATIONS = {
    "en": {
        ...
        "about.title": "About IP Local Scan",
        "about.description": "Local network scanner for administrators",
        "about.name_label": "Application",
        "about.description_label": "Description",
        "about.version_label": "Version",
        "about.author_label": "Author",
        "about.github_label": "GitHub",
        "about.python_label": "Python",
        "about.os_label": "Operating system",
        "about.copy_button": "Copy info",
        "about.close_button": "Close",
        "about.copy_success_title": "Information copied",
        "about.copy_success_message": "Application information was copied to the clipboard.",
        "export.csv.title": "Export CSV",
        "export.csv.save_dialog_title": "Save CSV file",
        "export.csv.file_filter": "CSV Files (*.csv);;All Files (*)",
        "export.csv.no_rows": "There are no visible rows to export.",
        "export.csv.success": "Results were exported to:\n{path}",
        "export.csv.failed": "Failed to export CSV: {reason}",
    ...
    "ru": {
        ...
        "about.title": "О программе IP Local Scan",
        "about.description": "Локальный сетевой сканер для администраторов",
        "about.name_label": "Приложение",
        "about.description_label": "Описание",
        "about.version_label": "Версия",
        "about.author_label": "Автор",
        "about.github_label": "GitHub",
        "about.python_label": "Python",
        "about.os_label": "Операционная система",
        "about.copy_button": "Копировать информацию",
        "about.close_button": "Закрыть",
        "about.copy_success_title": "Информация скопирована",
        "about.copy_success_message": "Информация о приложении скопирована в буфер обмена.",
        "export.csv.title": "Экспорт CSV",
        "export.csv.save_dialog_title": "Сохранить CSV-файл",
        "export.csv.file_filter": "Файлы CSV (*.csv);;Все файлы (*)",
        "export.csv.no_rows": "Нет видимых строк для экспорта.",
        "export.csv.success": "Результаты экспортированы в:\n{path}",
        "export.csv.failed": "Не удалось экспортировать CSV: {reason}",
