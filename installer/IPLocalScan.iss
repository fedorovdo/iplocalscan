...
[Files]
Source: "..\dist\iplocalscan\iplocalscan.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\dist\iplocalscan\_internal\*"; DestDir: "{app}\_internal"; Flags: ignoreversion recursesubdirs createallsubdirs
